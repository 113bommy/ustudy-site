...
window.SURVEY_CONFIG = {
  ...
  bases: [
    {
        ...
        "prompts": [
            ...
            "003_white_orange_tabby",
            "004_woman_singing_standing"
        ]
    },
    {
        "id": "self_forcing",
        ...
        "prompts": [
            ...
            "002_close_up_shot",
            "003_hyper_realistic_macro",
            "004_macro_shot_focusing",
            "005_side_profile_shot",
            "006_tropical_island_beach"
        ]
    }
],
  ...
  prompt_texts: {
    ...
    "rolling_forcing/003_white_orange_tabby": "A white and orange tabby cat is seen happily darting through a dense garden, as if chasing something. Its eyes are wide and happy as it jogs forward, scanning the branches, flowers, and leaves as it walks. The path is narrow as it makes its way between all the plants. the scene is captured from a ground-level angle, following the cat closely, giving a low and intimate perspective. The image is cinematic with warm tones and a grainy texture. The scattered daylight between the leaves and plants above creates a warm contrast, accentuating the cat’s orange fur. The shot is clear and sharp, with a shallow depth of field.",
    "rolling_forcing/004_woman_singing_standing": "A woman singing and standing in a concert stage with a bright light in the background.",
